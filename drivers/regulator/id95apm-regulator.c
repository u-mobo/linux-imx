...
#define ID95APM_REGULATOR(_name, _id, _ops, _n)	\
	{					\
		.name = _name, 			\
		.id = _id,			\
		.ops = &_ops,			\
...
static struct regulator_desc regulators[] = {
	...
	[ID95APM_REGULATOR_LDO0] =
		ID95APM_REGULATOR("ldo0", ID95APM_REGULATOR_LDO0,
				  id95apm_ldo_ops, ID95APM_LDO_STEPS),
	[ID95APM_REGULATOR_LDO1] =
		ID95APM_REGULATOR("ldo1", ID95APM_REGULATOR_LDO1,
				  id95apm_ldo_ops, ID95APM_LDO_STEPS),
	[ID95APM_REGULATOR_LDO2] =
		ID95APM_REGULATOR("ldo2", ID95APM_REGULATOR_LDO2,
				  id95apm_ldo_ops, ID95APM_LDO_STEPS),

	/* 4 * 50mA */
	[ID95APM_REGULATOR_LDO3] =
		ID95APM_REGULATOR("ldo3", ID95APM_REGULATOR_LDO3,
				  id95apm_ldo_ops, ID95APM_LDO_STEPS),
	[ID95APM_REGULATOR_LDO4] =
		ID95APM_REGULATOR("ldo4", ID95APM_REGULATOR_LDO4,
				  id95apm_ldo_ops, ID95APM_LDO_STEPS),
	[ID95APM_REGULATOR_LDO5] =
		ID95APM_REGULATOR("ldo5", ID95APM_REGULATOR_LDO5,
				  id95apm_ldo_ops, ID95APM_LDO_STEPS),
	[ID95APM_REGULATOR_LDO6] =
		ID95APM_REGULATOR("ldo6", ID95APM_REGULATOR_LDO6,
				  id95apm_ldo_ops, ID95APM_LDO_STEPS),

	/* 1 * 1mA */
	[ID95APM_REGULATOR_LDO7] =
		ID95APM_REGULATOR("ldo7", ID95APM_REGULATOR_LDO7,
				  id95apm_ldo_ops, 2),
	...
	[ID95APM_REGULATOR_DCDC0] =
		ID95APM_REGULATOR("dcdc0", ID95APM_REGULATOR_DCDC0,
				  id95apm_ldo_ops, ID95APM_LDO_STEPS),
	[ID95APM_REGULATOR_DCDC1] =
		ID95APM_REGULATOR("dcdc1", ID95APM_REGULATOR_DCDC1,
				  id95apm_ldo_ops, ID95APM_LDO_STEPS),

	/* Buck 1000 */
	[ID95APM_REGULATOR_DCDC2] =
		ID95APM_REGULATOR("dcdc2", ID95APM_REGULATOR_DCDC2,
				  id95apm_ldo_ops, ID95APM_LDO_STEPS),

	/* Boost 5 */
	[ID95APM_REGULATOR_DCDC3] =
		ID95APM_REGULATOR("dcdc3", ID95APM_REGULATOR_DCDC3,
				  id95apm_ldo_ops, ID95APM_BOOST5_STEPS),

	/* LED Boost current sink */
	[ID95APM_REGULATOR_DCDC4] =
		ID95APM_REGULATOR("dcdc4", ID95APM_REGULATOR_DCDC4,
...
static int __devinit id95apm_regulator_probe(struct platform_device *pdev)
{
	struct regulator_dev *rdev;
	struct id95apm *id95apm;
	...
	rdev = regulator_register(&regulators[pdev->id], &pdev->dev,
				  pdev->dev.platform_data, id95apm);
#else
	rdev = regulator_register(&regulators[pdev->id], &pdev->dev,
...
static int __devexit id95apm_regulator_remove(struct platform_device *pdev)
{
...
static struct platform_driver id95apm_regulator_driver = {
	...
	.remove = __devexit_p(id95apm_regulator_remove),
};
