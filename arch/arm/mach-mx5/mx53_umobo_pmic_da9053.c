...
static struct regulator_init_data da9052_regulators_init[] = {
	...
	DA9052_LDO(DA9052_LDO2_VOLT_UPPER,
		DA9052_LDO2_VOLT_LOWER, "DA9052_LDO2", 0),	/* turned off */
	...
	DA9052_LDO(DA9052_LDO567810_VOLT_UPPER,
		DA9052_LDO567810_VOLT_LOWER, "DA9052_LDO6", 0),	/* turned off */
	DA9052_LDO(DA9052_LDO567810_VOLT_UPPER,
	...
	DA9052_LDO(DA9052_LDO567810_VOLT_UPPER,
		DA9052_LDO567810_VOLT_LOWER, "DA9052_LDO10", 0),/* turned off */
...
{
	/* Set interrupt as HIGH LEVEL interrupt source */
	set_irq_type(gpio_to_irq(MX53_UMOBO_DA9052_IRQ), IRQF_TRIGGER_HIGH);
