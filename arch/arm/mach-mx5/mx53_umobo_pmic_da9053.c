...
/*
 * mx53_umobo_pmic_da9053.c  --  i.MX53 U-MoBo driver for pmic da9053
 */
...
static struct regulator_consumer_supply ld03_consumers[] = {
...
static struct regulator_init_data da9052_regulators_init[] = {
	...
	DA9052_LDO(DA9052_LDO2_VOLT_UPPER,
		DA9052_LDO2_VOLT_LOWER, "DA9052_LDO2", 0, 0, NULL),
	DA9052_LDO(DA9052_LDO34_VOLT_UPPER,
		DA9052_LDO34_VOLT_LOWER, "DA9052_LDO3", 3300,
		ARRAY_SIZE(ld03_consumers), ld03_consumers),
	DA9052_LDO(DA9052_LDO34_VOLT_UPPER,
	...
	DA9052_LDO(DA9052_LDO567810_VOLT_UPPER,
		DA9052_LDO567810_VOLT_LOWER, "DA9052_LDO6", 3300, 0, NULL),
	DA9052_LDO(DA9052_LDO567810_VOLT_UPPER,
	...
	DA9052_LDO(DA9052_LDO9_VOLT_UPPER,
		DA9052_LDO9_VOLT_LOWER, "DA9052_LDO9", 3300,
		ARRAY_SIZE(ld09_consumers), ld09_consumers),
	DA9052_LDO(DA9052_LDO567810_VOLT_UPPER,
		DA9052_LDO567810_VOLT_LOWER, "DA9052_LDO10", 0, 0, NULL),
...
static struct regulator_consumer_supply mx53_umobo_cpu_vddvpu_consumers[] = {
	REGULATOR_SUPPLY("cpu_vddvpu", NULL),
};

static struct regulator_init_data mx53_umobo_cpu_vddvpu_init = {
	.num_consumer_supplies = ARRAY_SIZE(mx53_umobo_cpu_vddvpu_consumers),
	.consumer_supplies = mx53_umobo_cpu_vddvpu_consumers,
};

static struct fixed_voltage_config mx53_umobo_cpu_vddvpu_reg_config = {
	.supply_name		= "cpu_vddvpu",
	.microvolts		= 3300000,
	.gpio			= -1,
	.init_data		= &mx53_umobo_cpu_vddvpu_init,
};

static struct platform_device mx53_umobo_cpu_vddvpu_reg_devices = {
	.name	= "reg-fixed-voltage",
	.id	= 2,
	.dev	= {
		.platform_data = &mx53_umobo_cpu_vddvpu_reg_config,
	},
};
...
#define MX53_UMOBO_DA9052_IRQ			(3*32 + 4)	/* GPIO4_4 */

static int __init umobo_da9052_init(struct da9052 *da9052)
{
	/* Set interrupt as LOW LEVEL interrupt source */
	irq_set_irq_type(gpio_to_irq(MX53_UMOBO_DA9052_IRQ), IRQF_TRIGGER_LOW);

	da9052_init_ssc_cache(da9052);
	platform_device_register(&mx53_umobo_cpu_vddvpu_reg_devices);

	return 0;
}

static struct da9052_platform_data __initdata da9052_plat = {
	.init = umobo_da9052_init,
...
static int da9052_i2c_addr = DA9052_I2C_ADDR >> 1;

static struct i2c_board_info __initdata da9052_i2c_device = {
	I2C_BOARD_INFO(DA9052_SSC_I2C_DEVICE_NAME, DA9052_I2C_ADDR >> 1),
	.irq = gpio_to_irq(MX53_UMOBO_DA9052_IRQ),
	.platform_data = &da9052_plat,
};

static int __init da9052_setup_i2c_addr(char *str)
{
	get_option(&str, &da9052_i2c_addr);
	return 1;
}

__setup("da9052_i2c_addr=", da9052_setup_i2c_addr);

int __init mx53_umobo_init_da9052(void)
{
	da9052_i2c_device.addr = da9052_i2c_addr;
