...
#ifndef _BOARD_MX6DL_SILVERBULLET_H
#define _BOARD_MX6DL_SILVERBULLET_H
#include <mach/iomux-mx6dl.h>

static iomux_v3_cfg_t mx6dl_silverbullet_pads[] = {
	/* AUDMUX */
	...
	MX6DL_PAD_KEY_ROW2__ECSPI1_SS2,
	...
	MX6DL_PAD_ENET_TX_EN__GPIO_1_28,	/* RGMII reset */
	...
	MX6DL_PAD_ENET_TXD1__GPIO_1_29,		// DTR
	MX6DL_PAD_EIM_A16__GPIO_2_22,		// DCD
	MX6DL_PAD_EIM_A17__GPIO_2_21,		// RI
	MX6DL_PAD_EIM_A19__GPIO_2_19,		// DSR

	/* USBOTG ID pin */
	MX6DL_PAD_ENET_RX_ER__ANATOP_USBOTG_ID,

	/* USB power pin */
	MX6DL_PAD_EIM_D22__GPIO_3_22,		// OTG_VBUSEN
	MX6DL_PAD_NANDF_CS0__GPIO_6_11,		// USBH_VBUSEN
	...
	MX6DL_PAD_NANDF_CS1__GPIO_6_14,		/* SD1_CD */
	MX6DL_PAD_NANDF_CS2__GPIO_6_15,		/* SD1_WP */
	...
	/* GPIO */
	MX6DL_PAD_NANDF_D0__GPIO_2_0,		// GPIO/nIRQ0
	MX6DL_PAD_NANDF_D1__GPIO_2_1,		// GPIO/nIRQ1
	MX6DL_PAD_NANDF_D2__GPIO_2_2,		// GPIO/nIRQ2
	MX6DL_PAD_NANDF_D3__GPIO_2_3,		// GPIO/nIRQ3
	MX6DL_PAD_NANDF_D4__GPIO_2_4,		// GPIO/nIRQ4
	MX6DL_PAD_NANDF_D5__GPIO_2_5,		// GPIO/nIRQ5
	MX6DL_PAD_NANDF_D6__GPIO_2_6,		// GPIO/nIRQ6
	MX6DL_PAD_NANDF_D7__GPIO_2_7,		// GPIO/nIRQ7
	MX6DL_PAD_NANDF_CLE__GPIO_6_7,		// GPIO8
	MX6DL_PAD_NANDF_WP_B__GPIO_6_9,		// GPIO9
	MX6DL_PAD_NANDF_RB0__GPIO_6_10,		// GPIO10
	MX6DL_PAD_CSI0_DATA_EN__GPIO_5_20,	// GPIO11
	MX6DL_PAD_SD3_DAT2__GPIO_7_6,		// GPIO12
	MX6DL_PAD_SD3_DAT3__GPIO_7_7,		// GPIO13
	MX6DL_PAD_SD3_DAT4__GPIO_7_1,		// GPIO14
	MX6DL_PAD_SD3_DAT5__GPIO_7_0,		// GPIO15

	MX6DL_PAD_NANDF_CS3__GPIO_6_16,		// PMIC_IRQ
	MX6DL_PAD_SD3_RST__GPIO_7_8,		// SYS_IRQ

	MX6DL_PAD_EIM_WAIT__GPIO_5_0,		// VID1_RESET
	MX6DL_PAD_EIM_A24__GPIO_5_4,		// VID1_PWREN
	MX6DL_PAD_EIM_EB0__GPIO_2_28,		// SYS_ALIVE
	MX6DL_PAD_EIM_EB1__GPIO_2_29,		// PSWITCH_PULSE
	MX6DL_PAD_EIM_EB3__GPIO_2_31,		// AUX_CLK_EN
};

static iomux_v3_cfg_t mx6dl_silverbullet_rgmii_rx_gpio_pads[] = {
...
static iomux_v3_cfg_t mx6dl_silverbullet_rgmii_rx_enet_pads[] = {
	MX6DL_PAD_RGMII_RX_CTL__ENET_RGMII_RX_CTL,
	MX6DL_PAD_RGMII_RD0__ENET_RGMII_RD0,
	MX6DL_PAD_RGMII_RD1__ENET_RGMII_RD1,
	MX6DL_PAD_RGMII_RD2__ENET_RGMII_RD2,
...
static iomux_v3_cfg_t mx6dl_silverbullet_csi0_sensor_pads[] = {
	/* IPU1 Camera */
	MX6DL_PAD_CSI0_MCLK__IPU1_CSI0_HSYNC,
	MX6DL_PAD_CSI0_PIXCLK__IPU1_CSI0_PIXCLK,
	MX6DL_PAD_CSI0_VSYNC__IPU1_CSI0_VSYNC,
	MX6DL_PAD_CSI0_DAT10__GPIO_5_28,	/* camera CTL */
	MX6DL_PAD_CSI0_DAT11__GPIO_5_29,	/* camera RESET */
...
static iomux_v3_cfg_t mx6dl_silverbullet_mipi_sensor_pads[] = {
	MX6DL_PAD_GPIO_0__CCM_CLKO,		/* camera clk */
};

static iomux_v3_cfg_t mx6dl_silverbullet_hdmi_ddc_pads[] = {
	MX6DL_PAD_KEY_COL3__HDMI_TX_DDC_SCL,	/* HDMI DDC SCL */
	MX6DL_PAD_KEY_ROW3__HDMI_TX_DDC_SDA,	/* HDMI DDC SDA */
};

static iomux_v3_cfg_t mx6dl_silverbullet_i2c2_pads[] = {
