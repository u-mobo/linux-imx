...
#define ID95APM_TSC_BAT_RES		0x0c5
#define ID95APM_TSC_TEMP_RES		0x0c7
#define ID95APM_TSC_CH3_RES		0x0c9
#define ID95APM_TSC_CH4_RES		0x0cb
...
#define ID95APM_REG_NUM			(ID95APM_AUDIO_REG_LAST - \
					 ID95APM_AUDIO_REG_FIRST + 1)

/* Register bits */
#define ID95APM_ID			0x55

#define ID95APM_IRQ_GPIO0		0
...
#define ID95APM_NUM_REGULATORS		(ID95APM_REGULATOR_DCDC4 + 1)
#define ID95APM_NUM_PDEVS		(ID95APM_NUM_REGULATORS + 6)
