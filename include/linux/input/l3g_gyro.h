...
#ifndef __L3G_GYRO_H__
#define __L3G_GYRO_H__

#define L3G_GYRO_DEV_NAME	"l3g_gyro"

#define L3G_GYRO_ENABLED	1
#define L3G_GYRO_DISABLED	0

#ifdef __KERNEL__

#define L3G_GYRO_DEFAULT_TEMP_CALIBRATION	40

/* to set gpios numb connected to gyro interrupt pins,
 * the unused ones havew to be set to -EINVAL
 */
#define L3G_GYRO_DEFAULT_INT1_GPIO		(-EINVAL)
#define L3G_GYRO_DEFAULT_INT2_GPIO		(-EINVAL)

#define L3G_GYRO_MIN_POLL_PERIOD_MS	2

#define L3G_GYRO_FS_250DPS	0x00
#define L3G_GYRO_FS_500DPS	0x10
#define L3G_GYRO_FS_2000DPS	0x30

struct l3g_gyro_platform_data {
	int (*init)(void);
	void (*exit)(void);
	int (*power_on)(void);
	int (*power_off)(void);
